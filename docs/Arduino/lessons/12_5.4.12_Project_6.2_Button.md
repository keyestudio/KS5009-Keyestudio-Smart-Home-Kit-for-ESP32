### 5.4.12 Proyecto 6.2 Botón


#### **1. Descripción**

Hay dos botones para cambiar el color de la lámpara de ambiente.
...
Podemos cambiar el color de la lámpara de ambiente presionando los botones 1 y 2.