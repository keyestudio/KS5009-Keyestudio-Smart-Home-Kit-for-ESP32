...
⚠️ \ **注意:**\  コードファイルを開いたら、ESP32開発ボードが接続するためのWiFi名とパスワードを変更する必要があります。`ChinaNet-2.4G-0DF0`と`ChinaNet@233`をそれぞれご自身のWiFi名とパスワードに置き換えてください。これをアップロード前に必ず行ってください。そうしないとESP32ボードはネットワークに接続できません。
...
![画像71](../media/a94cd80683c4eecb3c1bcabd4a60747d.png)