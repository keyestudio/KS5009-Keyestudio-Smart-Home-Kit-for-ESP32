### 5.4.14 Projet 7.2 Allumer ou éteindre le ventilateur

Un bouton met le ventilateur en marche et l'autre bouton contrôle la vitesse du ventilateur.
...
Appuyez sur le bouton 1, le ventilateur commence à tourner ; appuyez sur le bouton 2 pour régler la vitesse (trois vitesses différentes), puis appuyez de nouveau sur le bouton 1 pour arrêter le ventilateur.